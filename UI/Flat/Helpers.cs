...
namespace VictoriApp.Framework.UI.Flat
{
	static class Helpers
	{
        public static Color FlatColor = Color.FromArgb(213, 63, 64);
		...
		public static FlatColors GetColors(Control control)
		{
			...
			while(control != null && (control.GetType() !=  typeof(FlatFormSkin)))
			{
			...
			if(control != null)
			{
                FlatFormSkin skin = (FlatFormSkin)control;
